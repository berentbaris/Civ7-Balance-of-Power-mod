...
('ASHOKA_ALT_MOD_AGENDA_WITHOUT_REGRET', 'UpdateFreq',     NULL, NULL, NULL, 10),
...
('ASHOKA_ALT_MOD_AGENDA_WITHOUT_REGRET', 'AwardAmtType2',  NULL, NULL, NULL, 'DIPLOMACY_AGENDA_AMT_LARGE'),
('ASHOKA_ALT_MOD_AGENDA_WITHOUT_REGRET', 'AwardTo3',       NULL, NULL, NULL, 'DIPLOMACY_AGENDA_AWARD_HIGHER_OR_EQUAL'),
('ASHOKA_ALT_MOD_AGENDA_WITHOUT_REGRET', 'AwardAmtType3',  NULL, NULL, NULL, 'DIPLOMACY_AGENDA_NEG_AMT_SMALL'),
('ASHOKA_ALT_MOD_AGENDA_WITHOUT_REGRET', 'AwardTo4',       NULL, NULL, NULL, 'DIPLOMACY_AGENDA_AWARD_LOWER'),
('ASHOKA_ALT_MOD_AGENDA_WITHOUT_REGRET', 'AwardAmtType4',  NULL, NULL, NULL, 'DIPLOMACY_AGENDA_AMT_SMALL');